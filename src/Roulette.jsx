...
const Roulette = ({ closeGame, setLevel, updateLevelInFirestore }) => {
    ...
    const reBet = () => {
        if (
            betsPlaced.includes(previousBets) ||
            betsPlaced == previousBets ||
    ...
    const placeBet = (betAmount, id) => {
        ...
        setPlaced((prevBetsPlaced) => [
            ...prevBetsPlaced,
            [id, betAmount, multiplier],
        ]);
    };
    ...
    const redNumbers = [
        3, 9, 12, 18, 21, 27, 30, 36, 5, 14, 23, 32, 1, 7, 16, 19, 25, 34,
    ];
                                ...
                                <div id="roulette-table">
                                    ...
                                    <div id="roulette-table-grid">
                                        <div id="row-one">
                                            <div className="row-subdivision-one">
                                                {rowOneNumbers.map((number) => (
                                                    <button
                                                        onClick={() => placeBet(chipSelected, number)}
                                                        className="numbers"
                                                    />
                                                ))}
                                                <div className="two-to-one">
                                                    {intervalBetsRowOne.map((item) => (
                                                        <IntervalBet
                                                            onClick={() =>
                                                                placeBet(chipSelected, item.interval[0])
                                                            }
                                            ...
                                            <div className="double-one">
                                                {doubleBetRowOne.map((numbers) => (
                                                    <button
                                                        onClick={() => placeBet(chipSelected, numbers)}
                                                    />
                                                ))}
                                            </div>
                                        ...
                                        <div id="row-five">
                                            ...
                                            {colours.map((item) => (
                                                <button
                                                    onClick={() => placeBet(chipSelected, item.colour)}
                                                />
                                            ))}
                                            {odd.map((item) => (
                                                <button
